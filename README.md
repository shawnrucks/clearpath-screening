...
The canonical application requires a Node.js runtime and persistent disk because operational actions are server-backed. `render.yaml` describes a compatible deployment. Set a strong `CLEARPATH_SESSION_SECRET` in every hosted environment.
